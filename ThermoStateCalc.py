...
"X = 1.0"))
        ...
        def addStateGroupBox(self, title):
            groupBox = QtWidgets.QGroupBox(title)
            layout = QtWidgets.QGridLayout()
            groupBox.setLayout(layout)

            cmbProperty1 = QtWidgets.QComboBox()
            cmbProperty2 = QtWidgets.QComboBox()
            leProperty1 = QtWidgets.QLineEdit("0")
            leProperty2 = QtWidgets.QLineEdit("0")
            lblProperty1Units = QtWidgets.QLabel("Units")
            lblProperty2Units = QtWidgets.QLabel("Units")

            # Populate your combo boxes with options
            cmbProperty1.addItems(
                ["Pressure (p)", "Temperature (T)", "Specific Volume (v)", "Specific Internal Energy (u)",
                 "Specific Enthalpy (h)", "Specific Entropy (s)", "Quality (x)"])
            cmbProperty2.addItems(
                ["Pressure (p)", "Temperature (T)", "Specific Volume (v)", "Specific Internal Energy (u)",
                 "Specific Enthalpy (h)", "Specific Entropy (s)", "Quality (x)"])

            # Add widgets to the layout
            layout.addWidget(cmbProperty1, 0, 0)
            layout.addWidget(leProperty1, 0, 1)
            layout.addWidget(lblProperty1Units, 0, 2)
            layout.addWidget(cmbProperty2, 1, 0)
            layout.addWidget(leProperty2, 1, 1)
            layout.addWidget(lblProperty2Units, 1, 2)
